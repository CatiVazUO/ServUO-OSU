...
namespace Server.Custom.Systems.HtmlBooks.Html.Readable
{
    public class HtmlBook250 : HtmlDocumentBase
    {
        ...
        public override DocumentGumpLayout GetLayout()
        {
            ...
            l.LeftPageLabelX = 326;
            l.LeftPageLabelY = 623;
            l.RightPageLabelX = 428;
            l.RightPageLabelY = 623;
        ...
        public HtmlBook250(Serial serial) : base(serial)
        {
        }
