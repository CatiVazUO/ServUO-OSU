...
namespace Server.Custom.Systems.Crafting.Tailoring.Fabrics.Bolts
{
    ...
    public class BoltOfSilk : Item, IScissorable, IDyable//, ICommodity
    {
        [Constructable]
        public BoltOfSilk()
            : this(1)
        ...
        public BoltOfSilk(Serial serial)
            : base(serial)
        {
        }
        ...
        public bool Scissor(Mobile from, Scissors scissors)
        {
            ...
            base.ScissorHelper(from, new SilkCloth(), 50);
