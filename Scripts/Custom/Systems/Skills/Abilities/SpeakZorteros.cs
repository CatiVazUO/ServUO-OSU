...
{
    /// <summary>
    /// Habilidade: Falar: Língua do Povo 4
    ...
    /// </summary>
    public class SpeakZorteros : IOSUAbility
    {
        ...
        public SpeakZorteros()
        {
            Definition = new OSUAbilityDefinition(
                id: 210005,
                name: "Falar: Língua do Povo 4",
                desc: "Permite ler livros/pergaminhos selados escritos na língua do Povo 4.",
                costPicks: 1,
                commandText: "",
                requiredFeatId: 0,
                requiredAbilityId: 0,
        ...
        public bool CanPurchase(PlayerMobile pm, out string reason)
        {
            ...
            if (native == OSULanguage.Zorteros)
            {
