...
namespace Server.Custom.Systems.Reinos
{
    public class CorreiosAuroraFase1Multi : ReinoPlacedMultiBase
    {
        ...
        public CorreiosAuroraFase1Multi(int referenceId, string constructionId, int stageIndex) : base(0xA3, referenceId, constructionId, stageIndex) { Name = "Correios Aurora (Fase 1)"; }
    ...
    public class CorreiosAuroraFase2Multi : ReinoPlacedMultiBase
    {
        ...
        public CorreiosAuroraFase2Multi(int referenceId, string constructionId, int stageIndex) : base(0xA4, referenceId, constructionId, stageIndex) { Name = "Correios Aurora (Fase 2)"; }
    ...
    public class CorreiosAuroraFase3Multi : ReinoPlacedMultiBase
    {
        ...
        public CorreiosAuroraFase3Multi(int referenceId, string constructionId, int stageIndex) : base(0xA5, referenceId, constructionId, stageIndex) { Name = "Correios Aurora (Fase 3)"; }
        public CorreiosAuroraFase3Multi(Serial serial) : base(serial) { }
    }

    public class CorreiosAuroraFase4Multi : ReinoPlacedMultiBase
    {
        [Constructable] public CorreiosAuroraFase4Multi() : this(0, string.Empty, 3) { }
        public CorreiosAuroraFase4Multi(int referenceId, string constructionId, int stageIndex) : base(0xA6, referenceId, constructionId, stageIndex) { Name = "Correios Aurora (Fase 3)"; }
    ...
    public class CorreiosAuroraProntoMulti : ReinoPlacedMultiBase
    {
        ...
        public CorreiosAuroraProntoMulti(int referenceId, string constructionId, int stageIndex) : base(0xA7, referenceId, constructionId, stageIndex) { Name = "Correios Aurora"; }
    ...
    public class CorreiosAuroraAbandonadoMulti : ReinoPlacedMultiBase
    {
        ...
        public CorreiosAuroraAbandonadoMulti(int referenceId, string constructionId, int stageIndex) : base(0xA8, referenceId, constructionId, stageIndex) { Name = "Correios Aurora Abandonado"; }
