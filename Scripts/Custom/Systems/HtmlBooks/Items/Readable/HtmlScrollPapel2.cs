...
{
    public class HtmlScrollPapel2 : HtmlDocumentBase
    {
        // Ajuste quando você souber o retângulo exato do HTML desse gump 3510
        public override int HtmlWidth { get { return 262; } }
        public override int HtmlHeight { get { return 349; } }
        ...
        public HtmlScrollPapel2(Serial serial) : base(serial)
        {
        }
