...
namespace Server.Custom.Systems.Rent
{
	public class TownHouse : VersionHouse
	{
        ...
        public override int GetAosMaxSecures()
        {
            ...
            // No sistema custom de rent, o GM define quantidade de secure containers.
            // Em AOS, MaxSecures representa capacidade de storage.
            // Convertemos 1 secure -> 125 storage slots para alinhar com o comportamento esperado.
            return MaxSecures * 125;
        }
        ...
        {
            if (c_Hanger != null && !c_Hanger.Deleted)
                c_Hanger.Delete();
            ...
            try
            {
                if (Sign != null && !Sign.Deleted)
                {
                    ...
                    {
                        if (item != null && item != Sign && !item.Deleted)
                            item.Visible = true;
                    }
                }
            }
