...
{
    public class HtmlScrollLongo4 : HtmlDocumentBase
    {
        // Ajuste quando você souber o retângulo exato do HTML desse gump 3510
        public override int HtmlWidth { get { return 143; } }
        public override int HtmlHeight { get { return 514; } }
        ...
        public HtmlScrollLongo4(Serial serial) : base(serial)
        {
        }
