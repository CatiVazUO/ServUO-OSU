...
namespace Server.Items
{
    ...
    public class OSUMedicatedBandage : Bandage
    {
        ...
        [Constructable]
        public OSUMedicatedBandage() : this(1, OSUMedicatedBandageType.HealingBonus, 1150)
        {
        }
    ...
    public class OSUMedicationTub : DyeTub, IHospitalBoundItem
    {
        ...
        public string GetEffectDescription()
        {
            ...
            {
                case OSUMedicatedBandageType.HealingBonus:
                    return "<BASEFONT COLOR=#000000>Esse remédio dá um pequeno bônus de cura por bandagem usada.</BASEFONT>";
                case OSUMedicatedBandageType.SpeedBonus:
                    return "<BASEFONT COLOR=#000000>Esse remédio faz a bandagem agir um pouco mais rápido.</BASEFONT>";
                case OSUMedicatedBandageType.Antiseptic:
                    return "<BASEFONT COLOR=#000000>Esse remédio aumenta um pouco a chance de parar poison ou bleed.</BASEFONT>";
                default:
                    return "<BASEFONT COLOR=#000000>Remédio sem efeito configurado.</BASEFONT>";
            }
        }
    ...
    public abstract class OSUBaseHospitalStretcher : Item, IHospitalBoundItem
    {
        ...
        protected OSUBaseHospitalStretcher(Serial serial) : base(serial)
        {
        }
    ...
    public class OSUHospitalRecoveryStretcher : OSUBaseHospitalStretcher
    {
        ...
        public OSUHospitalRecoveryStretcher(int cityId, string constructionKey) : base(2656, cityId, constructionKey, "maca de recuperação")
        {
        }
    ...
    public class OSUSurgeryStretcher : OSUBaseHospitalStretcher
    {
        ...
        public OSUSurgeryStretcher(int cityId, string constructionKey) : base(4605, cityId, constructionKey, "maca cirúrgica")
        {
        }
    ...
    public class OSUSurgeryDecorItem : Item, IHospitalBoundItem
    {
        private int _cityId;
        private string _constructionKey;
        [CommandProperty(AccessLevel.GameMaster)] public int CityId { get { return _cityId; } }
        [CommandProperty(AccessLevel.GameMaster)] public string ConstructionKey { get { return _constructionKey; } }
        [Constructable]
        public OSUSurgeryDecorItem() : this(0x1801, 0, String.Empty, "decoração cirúrgica", 0) { }
        [Constructable]
        public OSUSurgeryDecorItem(int itemId, int cityId, string constructionKey, string name, int hue) : base(itemId)
        {
            _cityId = cityId; _constructionKey = constructionKey ?? String.Empty; Name = name; Movable = false; Hue = hue;
        }
        public OSUSurgeryDecorItem(Serial serial) : base(serial) { }
        public override void Serialize(GenericWriter writer) { base.Serialize(writer); writer.Write(0); writer.Write(_cityId); writer.Write(_constructionKey ?? String.Empty); }
        public override void Deserialize(GenericReader reader) { base.Deserialize(reader); reader.ReadInt(); _cityId = reader.ReadInt(); _constructionKey = reader.ReadString(); Movable = false; }
    }

    public class OSUMesaCirurgicaNorte :
       OSUSurgeryDecorItem
    {
        [Constructable]
        ...
        public OSUMesaCirurgicaNorte(int cityId, string constructionKey) : base(4610, cityId, constructionKey, "mesa cirúrgica", 2101)
        {
        }
        public OSUMesaCirurgicaNorte(Serial s) : base(s)
        {
        }
    }

    public class OSUMesaCirurgicaCentro :
        OSUSurgeryDecorItem
    {
        [Constructable]
        ...
        public OSUMesaCirurgicaCentro(int cityId, string constructionKey) : base(4611, cityId, constructionKey, "mesa cirúrgica", 2101)
        {
        }
        public OSUMesaCirurgicaCentro(Serial s) : base(s)
        {
        }
    }
    public class OSUMesaCirurgicaSul :
        OSUSurgeryDecorItem
    {
        [Constructable]
        ...
        public OSUMesaCirurgicaSul(int cityId, string constructionKey) : base(4609, cityId, constructionKey, "mesa cirúrgica", 2101)
        {
        }
        public OSUMesaCirurgicaSul(Serial s) : base(s)
        {
        }
    }
    public class OSUSurgeryToolItem : Item, IHospitalBoundItem
    {
        ...
        [CommandProperty(AccessLevel.GameMaster)] public int CityId { get { return _cityId; } }
        [CommandProperty(AccessLevel.GameMaster)] public string ConstructionKey { get { return _constructionKey; } }
        [CommandProperty(AccessLevel.GameMaster)] public OSUSurgeryToolType ToolType { get { return _toolType; } }
        public OSUSurgeryToolItem(int cityId, string constructionKey, OSUSurgeryToolType toolType, int itemId, string name) : base(itemId)
        {
            _cityId = cityId; _constructionKey = constructionKey ?? String.Empty; _toolType = toolType; Name = name; Movable = false;
        }
        [Constructable]
        public OSUSurgeryToolItem() : this(0, String.Empty, OSUSurgeryToolType.FacaDisseccao, 3781, "instrumento cirúrgico") { }
        public override void OnDoubleClick(Mobile from)
        {
            ...
            from.SendMessage(_toolType == OSUSurgeryToolType.Anestesico ? "Escolha o paciente para anestesiar." : "Escolha o paciente da cirurgia.");
            from.Target = new SurgeryToolTarget(this);
        }
        private class SurgeryToolTarget : Target
        {
            private readonly OSUSurgeryToolItem _tool;
            public SurgeryToolTarget(OSUSurgeryToolItem tool) : base(2, false, TargetFlags.Beneficial) { _tool = tool; }
            protected override void OnTarget(Mobile from, object targeted)
            {
                PlayerMobile surgeon = from as PlayerMobile; PlayerMobile patient = targeted as PlayerMobile;
                if (surgeon == null || patient == null) { from.SendMessage("Escolha um paciente válido."); return; }
                string msg; OSUHealthSystem.TryUseSurgeryTool(surgeon, patient, _tool._toolType, _tool, out msg); from.SendMessage(msg);
            }
        }
        public OSUSurgeryToolItem(Serial serial) : base(serial) { }
        public override void Serialize(GenericWriter writer) { base.Serialize(writer); writer.Write(0); writer.Write(_cityId); writer.Write(_constructionKey ?? String.Empty); writer.Write((int)_toolType); }
        public override void Deserialize(GenericReader reader) { base.Deserialize(reader); reader.ReadInt(); _cityId = reader.ReadInt(); _constructionKey = reader.ReadString(); _toolType = (OSUSurgeryToolType)reader.ReadInt(); Movable = false; }
    }
    public class OSUAnestesicoCirurgico : OSUSurgeryToolItem { [Constructable] public OSUAnestesicoCirurgico() : this(0, String.Empty) { } public OSUAnestesicoCirurgico(int cityId, string constructionKey) : base(cityId, constructionKey, OSUSurgeryToolType.Anestesico, 3626, "anestésico") { } public OSUAnestesicoCirurgico(Serial s) : base(s) { } }
    public class OSUFacaDisseccaoCirurgica : OSUSurgeryToolItem { [Constructable] public OSUFacaDisseccaoCirurgica() : this(0, String.Empty) { } public OSUFacaDisseccaoCirurgica(int cityId, string constructionKey) : base(cityId, constructionKey, OSUSurgeryToolType.FacaDisseccao, 3781, "bisturi") { } public OSUFacaDisseccaoCirurgica(Serial s) : base(s) { } }
    public class OSUTesouraCirurgica : OSUSurgeryToolItem { [Constructable] public OSUTesouraCirurgica() : this(0, String.Empty) { } public OSUTesouraCirurgica(int cityId, string constructionKey) : base(cityId, constructionKey, OSUSurgeryToolType.Tesoura, 3998, "tesoura cirúrgica") { } public OSUTesouraCirurgica(Serial s) : base(s) { } }
    public class OSUAguaEsterilCirurgica : OSUSurgeryToolItem { [Constructable] public OSUAguaEsterilCirurgica() : this(0, String.Empty) { } public OSUAguaEsterilCirurgica(int cityId, string constructionKey) : base(cityId, constructionKey, OSUSurgeryToolType.AguaEsteril, 4088, "água estéril") { } public OSUAguaEsterilCirurgica(Serial s) : base(s) { } }
    public class OSUGazesCirurgicas : OSUSurgeryToolItem { [Constructable] public OSUGazesCirurgicas() : this(0, String.Empty) { } public OSUGazesCirurgicas(int cityId, string constructionKey) : base(cityId, constructionKey, OSUSurgeryToolType.Gazes, 3617, "gaze cirúrgica") { } public OSUGazesCirurgicas(Serial s) : base(s) { } }
    public class OSUVelaCauterizadora : OSUSurgeryToolItem { [Constructable] public OSUVelaCauterizadora() : this(0, String.Empty) { } public OSUVelaCauterizadora(int cityId, string constructionKey) : base(cityId, constructionKey, OSUSurgeryToolType.VelaCauterizadora, 5169, "vela cauterizadora") { } public OSUVelaCauterizadora(Serial s) : base(s) { } }
    public class OSUBrasaCauterizadora : OSUSurgeryToolItem { [Constructable] public OSUBrasaCauterizadora() : this(0, String.Empty) { } public OSUBrasaCauterizadora(int cityId, string constructionKey) : base(cityId, constructionKey, OSUSurgeryToolType.BrasaCauterizadora, 4024, "brasa cauterizadora") { } public OSUBrasaCauterizadora(Serial s) : base(s) { } }
    public class OSUSanguessugaCirurgica : OSUSurgeryToolItem { [Constructable] public OSUSanguessugaCirurgica() : this(0, String.Empty) { } public OSUSanguessugaCirurgica(int cityId, string constructionKey) : base(cityId, constructionKey, OSUSurgeryToolType.Sanguessuga, 2425, "sanguessuga") { } public OSUSanguessugaCirurgica(Serial s) : base(s) { } }
    public class OSULinhaDeSutura : OSUSurgeryToolItem { [Constructable] public OSULinhaDeSutura() : this(0, String.Empty) { } public OSULinhaDeSutura(int cityId, string constructionKey) : base(cityId, constructionKey, OSUSurgeryToolType.LinhaSutura, 3997, "kit de sutura") { } public OSULinhaDeSutura(Serial s) : base(s) { } }
    public class OSUAdagaDeSangria : OSUSurgeryToolItem { [Constructable] public OSUAdagaDeSangria() : this(0, String.Empty) { } public OSUAdagaDeSangria(int cityId, string constructionKey) : base(cityId, constructionKey, OSUSurgeryToolType.AdagaSangria, 3921, "adaga de drenagem") { } public OSUAdagaDeSangria(Serial s) : base(s) { } }
    public class OSUCuteloCirurgico : OSUSurgeryToolItem { [Constructable] public OSUCuteloCirurgico() : this(0, String.Empty) { } public OSUCuteloCirurgico(int cityId, string constructionKey) : base(cityId, constructionKey, OSUSurgeryToolType.CuteloCirurgico, 3779, "cutelo cirúrgico") { } public OSUCuteloCirurgico(Serial s) : base(s) { } }
    public class OSUTochaCauterizadora : OSUSurgeryToolItem { [Constructable] public OSUTochaCauterizadora() : this(0, String.Empty) { } public OSUTochaCauterizadora(int cityId, string constructionKey) : base(cityId, constructionKey, OSUSurgeryToolType.TochaCauterizadora, 3940, "álcool cirúrgico") { } public OSUTochaCauterizadora(Serial s) : base(s) { } }
    public class OSUAlcoolCirurgico : OSUSurgeryToolItem { [Constructable] public OSUAlcoolCirurgico() : this(0, String.Empty) { } public OSUAlcoolCirurgico(int cityId, string constructionKey) : base(cityId, constructionKey, OSUSurgeryToolType.AlcoolCirurgico, 3623, "álcool cirúrgico") { } public OSUAlcoolCirurgico(Serial s) : base(s) { } }
}
