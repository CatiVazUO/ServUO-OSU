...
{
    public class HtmlScroll6: HtmlDocumentBase
    {
        // Ajuste quando você souber o retângulo exato do HTML desse gump 3510
        public override int HtmlWidth { get { return 300; } }
        public override int HtmlHeight { get { return 500; } }
        ...
        public HtmlScroll6(Serial serial) : base(serial)
        {
        }
