...
{
    public class HtmlScrollPapel4 : HtmlDocumentBase
    {
        // Ajuste quando você souber o retângulo exato do HTML desse gump 3510
        public override int HtmlWidth { get { return 249; } }
        public override int HtmlHeight { get { return 338; } }
        ...
        public HtmlScrollPapel4(Serial serial) : base(serial)
        {
        }
