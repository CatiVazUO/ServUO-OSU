...
{
    public class HtmlBook200 : HtmlDocumentBase
    {
        ...
        public override int PageCount => 200;

        [Constructable]
        public HtmlBook200()
        {
            ItemID = 0xFEF;
            Name = "Livro (200 páginas)";
            Weight = 3.0;
        ...
        public override DocumentGumpLayout GetLayout()
        {
            ...
            l.LeftPageLabelY = 617;
            l.RightPageLabelX = 500;
            l.RightPageLabelY = 617;
        ...
        public HtmlBook200(Serial serial) : base(serial)
        {
        }
