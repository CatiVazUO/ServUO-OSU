...
namespace Server.Custom.Systems.Crafting.Tailoring.Fabrics.Bolts
{
    ...
    public class BoltOfWool : Item, IScissorable, IDyable//, ICommodity
    {
        [Constructable]
        public BoltOfWool()
            : this(1)
        ...
        public BoltOfWool(Serial serial)
            : base(serial)
        {
        }
      ...
      /*  TextDefinition ICommodity.Description
        ...
        public bool Scissor(Mobile from, Scissors scissors)
        {
            ...
            base.ScissorHelper(from, new WoolCloth(), 50);
