...
namespace Server.Custom.Systems.Crafting.Tailoring.Fabrics.Cloths
{
    ...
    public class WoolCloth : Cloth, IScissorable, IDyable//, ICommodity
    {
        [Constructable]
        public WoolCloth()
            : this(1)
        ...
        public WoolCloth(Serial serial)
            : base(serial)
        {
        }
        ...
        bool IScissorable.Scissor(Mobile from, Scissors scissors)
        {
            ...
            base.ScissorHelper(from, new WoolBandage(), 1);
            return true;
        }
    }

    public class CutUpWoolCloth : Item
    {
        public override int LabelNumber { get { return 1044458; } } // cut-up cloth

        [Constructable]
        public CutUpWoolCloth()
            : base(0x1767)
        {
        }

        public CutUpWoolCloth(Serial serial)
            : base(serial)
        {
        }
    ...
    public class CombineWoolCloth : Item
    {
        public override int LabelNumber { get { return 1044459; } } // combine cloth

        [Constructable]
        public CombineWoolCloth()
            : base(0x1767)
        {
        }

        public CombineWoolCloth(Serial serial)
            : base(serial)
        {
        }
        ...
        public void Combine(Mobile from, Item[] items)
        {
            ...
            for (int i = 0; i < items.Length; i++)
            {
                WoolCloth c = items[i] as WoolCloth;
