...
namespace Server.Custom.Reinos
{
    public static class TribunalAuroraDefinition
    {
        ...
        public static readonly Point3D ACCUSED_OFFSET = new Point3D(4, 5, 0);
        ...
        public static ReinoConstructionDefinition Create()
        {
            ...
            sb.Append("Use este arquivo para ajustar as coordenadas da mesa do tribunal, do oficial de justiça e do ponto onde o réu ficará durante a sessão.");
            sb.Append("</BASEFONT>");
