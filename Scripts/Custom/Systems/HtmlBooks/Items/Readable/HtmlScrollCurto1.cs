...
namespace Server.Custom.Systems.HtmlBooks.Html.Readable
{
    public class HtmlScrollCurto1 : HtmlDocumentBase
    {
        ...
        public HtmlScrollCurto1(Serial serial) : base(serial)
        {
        }
