...
{
    public class HtmlScrollPlaca2 : HtmlDocumentBase
    {
        // Ajuste quando você souber o retângulo exato do HTML desse gump 3510
        public override int HtmlWidth { get { return 465; } }
        public override int HtmlHeight { get { return 282; } }
        ...
        public HtmlScrollPlaca2(Serial serial) : base(serial)
        {
        }
