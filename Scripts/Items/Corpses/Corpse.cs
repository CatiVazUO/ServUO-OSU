...
namespace Server.Items
{
    ...
    public class Corpse : Container, ICarvable
    {
        ...
        public override void Serialize(GenericWriter writer)
        {
            ...
            writer.Write(OSUKnockoutCorpse);
        ...
        public override void Deserialize(GenericReader reader)
        {
            ...
            switch (version)
            {
                case 13:
                    {
                        OSUKnockoutCorpse = reader.ReadBool();
                        goto case 12;
                    }
                case 12:
                {
        ...
        public override void AddNameProperty(ObjectPropertyList list)
        {
            ...
            {
                // OSU: corpse de desmaio mostra só o nome
            ...
            {
                // OSU: se quiser, também aplica no bone form do desmaio
                if (OSUKnockoutCorpse)
                {
                    list.Add(Name);
                }
