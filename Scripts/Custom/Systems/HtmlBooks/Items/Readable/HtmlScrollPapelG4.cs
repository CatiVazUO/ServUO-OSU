...
{
    public class HtmlScrollPapelG4 : HtmlDocumentBase
    {
        // Ajuste quando você souber o retângulo exato do HTML desse gump 3510
        public override int HtmlWidth { get { return 683; } }
        public override int HtmlHeight { get { return 410; } }
        ...
        public HtmlScrollPapelG4(Serial serial) : base(serial)
        {
        }
