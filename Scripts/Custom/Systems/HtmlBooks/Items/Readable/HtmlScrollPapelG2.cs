...
namespace Server.Custom.Systems.HtmlBooks.Html.Readable
{
    public class HtmlScrollPapelG2 : HtmlDocumentBase
    {
        ...
        public HtmlScrollPapelG2(Serial serial) : base(serial)
        {
        }
