...
{
    public class HtmlScrollLongo1 : HtmlDocumentBase
    {
        // Ajuste quando você souber o retângulo exato do HTML desse gump 3510
        public override int HtmlWidth { get { return 162; } }
        ...
        public HtmlScrollLongo1(Serial serial) : base(serial)
        {
        }
